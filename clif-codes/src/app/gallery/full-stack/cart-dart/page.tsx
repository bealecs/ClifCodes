...
export default function CartDart() {
    return (
        <ProjectDisplay website="https://cart-dart.vercel.app" projectName="Cart Dart" imageSrc="/cartDartLogo.svg" github="https://github.com/bealecs/CartDart" description={description} missionStatement={missionStatement} technologies={technologies}  />
    )
}