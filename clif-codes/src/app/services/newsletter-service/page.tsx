...
export default function Page() {
    ...
    const emailService: EmailService = {
        ...
        serviceDescription2: "Once the subscription system is set up, I implement mechanisms for managing email lists, handling subscriber preferences, and sending out newsletters or marketing emails. I may also need to ensure compliance with email regulations such as GDPR and CAN-SPAM by providing opt-in/opt-out options, honoring unsubscribe requests, and maintaining transparent data handling practices. By effectively implementing newsletters and email subscriptions, I can help my clients build and nurture relationships with their audience, driving engagement and fostering customer loyalty.",
        serviceImageLink: "/newsletter.svg",
        serviceApplicableTechnologies: ["AWS SES", "AWS SNS", "Resend", "Supabase", "Firebase"]
    }
